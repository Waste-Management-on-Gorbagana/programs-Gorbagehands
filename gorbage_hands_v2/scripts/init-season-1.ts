/**
 * Initialize Season 1 for Gorbage Hands
 * 
 * This script:
...
const SEASON_CONFIG = {
  ...
  // Registration opens now, runs for 1 day
...
async function main() {
  console.log('🎮 Gorbage Hands - Season 1 Initialization Script\n');
  ...
  console.log('\n✅ Season 1 initialization complete!');
  console.log('\n📋 Summary:');
  console.log(`   Season: ${SEASON_CONFIG.name}`);
  console.log(`   Entry Fee: ${SEASON_CONFIG.entryFee} GOR`);
  console.log(`   Season PDA: ${seasonPDA.toBase58()}`);
  console.log(`   Vault PDA: ${vaultPDA.toBase58()}`);
  console.log(`   Registration: ${SEASON_CONFIG.registrationDurationDays} days`);
