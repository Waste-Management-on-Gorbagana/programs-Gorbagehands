...
pub struct InitializeSeason<'info> {
    ...
    /// The Gorbagio NFT collection address (verified authority for Token 2022 collection)
    /// CHECK: Set by authority during initialization
    pub gorbagio_collection_address: UncheckedAccount<'info>,
...
pub fn handler(
    ...
    msg!("Buy-in: {} lamports", buy_in_amount);
